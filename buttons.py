...
if __name__ == '__main__':
    ...
    mcp.config(0, mcp.OUTPUT)  #LED radio ON
    mcp.config(1, mcp.OUTPUT)  #LED radio OFF
    #mcp.config(2, mcp.INPUT)   #botao next/play
    #mcp.config(3, mcp.INPUT)   #botao prev
    #mcp.config(4, mcp.INPUT)   #botao volume +
    #mcp.config(5, mcp.INPUT)   #botao volume -
    #mcp.config(6, mcp.INPUT)   #botao stop
    ...
    while (True):
      ...
      if stat == "" and (not mcp.input(2) >> 2):
          os.system("mpc play")
          time.sleep(0.5)
          
      if stat == "" and (not mcp.input(3) >> 3):
          os.system("mpc play")
          time.sleep(0.5)
          
      if stat == "" and (not mcp.input(4) >> 4):
          os.system("mpc play")
          time.sleep(0.5)

      if stat == "" and (not mcp.input(5) >> 5):
          os.system("mpc play")
          time.sleep(0.5)

      if stat == "" and (not mcp.input(6) >> 6):
          os.system("mpc play")
          time.sleep(0.5)

      if (not mcp.input(3) >> 3):
            os.system("mpc next")
            time.sleep(0.5)
            #os.system("mpc play")
      ...
      if (not mcp.input(4) >> 4):
            os.system("mpc volume +2")
            time.sleep(0.5)
            #os.system("mpc play")

      if (not mcp.input(5) >> 5):
            os.system("mpc volume -2")
            time.sleep(0.5)
            #os.system("mpc play")

      if (not mcp.input(6) >> 6):
            os.system("mpc stop")
            time.sleep(0.5)
